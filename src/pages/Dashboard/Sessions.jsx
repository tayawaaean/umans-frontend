...
import { 
  ...
  VpnKey as SessionIcon, FilterList as FilterIcon, Download as DownloadIcon,
...
const SessionsContainer = styled(Box)(({ theme }) => ({
...
export default function Sessions() {
    ...
    // Filter sessions based on user, app, or token
    const filteredSessions = sessions.filter((session) => {
        ...
        return `${userDisplayName} ${appName} ${session.token}`
            .toLowerCase()
            ...
            {loading || sessions[0] === 'empty'? <LoadingScreen caption='Loading...' fullScreen={false} /> : (
                sessions.length <= 0 ? (
                    <Box sx={{ textAlign: 'center', py: 8 }}>
                        <SessionIcon sx={{ fontSize: 64, color: 'text.secondary', mb: 2 }} />
                        <Typography variant="h5" color="text.secondary" gutterBottom>
                            No Active Sessions
                        </Typography>
                        <Typography variant="body1" color="text.secondary">
                            There are currently no active sessions in the system.
                        </Typography>
                    </Box>
                ) : (
                    <>
                        ...
                        <PageHeader>
                            ...
                            <PageSubtitle>Monitor and manage all active user sessions in your system</PageSubtitle>
                        </PageHeader>
                                    ...
                                    <CardContent sx={{ p: { xs: 2, sm: 3 }, pt: { xs: 1.5, sm: 2 } }}>
                                        <Stack direction="row" alignItems="center" spacing={2}>
                                            ...
                                            <Box>
                                                ...
                                                <StatsValue color="#1976d2">{totalSessions}</StatsValue>
                                            </Box>
                                        </Stack>
                                    </CardContent>
                                </StatsCard>
                                    ...
                                    <CardContent sx={{ p: { xs: 2, sm: 3 }, pt: { xs: 1.5, sm: 2 } }}>
                                        <Stack direction="row" alignItems="center" spacing={2}>
                                            ...
                                            <Box>
                                                ...
                                                <StatsValue color="#4caf50">{activeSessions}</StatsValue>
                                            </Box>
                                        </Stack>
                                    </CardContent>
                                </StatsCard>
                                    ...
                                    <CardContent sx={{ p: { xs: 2, sm: 3 }, pt: { xs: 1.5, sm: 2 } }}>
                                        <Stack direction="row" alignItems="center" spacing={2}>
                                            ...
                                            <Box>
                                                ...
                                                <StatsValue color="#ff9800">{recentSessions}</StatsValue>
                                            </Box>
                                        </Stack>
                                    </CardContent>
                                </StatsCard>
                        ...
                        <TableContainer >
                            <Box sx={{ p: 3, borderBottom: 1, borderColor: 'divider' }}>
                                <Grid container spacing={3} alignItems="center">
                                    <Grid item xs={12} md={6}>
                                        <EnhancedSearch
                                            fullWidth
                                            placeholder="Search by user, app, or token..."
                                            value={searchTerm}
                            ...
                            <SessionsTable sessions={paginatedSessions} users={users} apps={apps} loadingRowId={loadingRowId} />
