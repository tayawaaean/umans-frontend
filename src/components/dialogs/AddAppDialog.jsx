...
import { Autorenew as GenerateIcon, Visibility, VisibilityOff, Email, Phone, Business, Apps, Link } from "@mui/icons-material";
    ...
    <StyledDialog open={open} onClose={handleClose} fullWidth>
      <Fade in={open} timeout={300}>
        <Box>
          <DialogHeader>
            <DialogTitleStyled>
              <AppShortcutIcon sx={{ fontSize: 28 }} />
              Add New Application
            </DialogTitleStyled>
          </DialogHeader>
          ...
          <DialogContentStyled>
            ...
            <FormSection sx={{ animation: `${fadeInUp} 0.6s ease-out 0.2s both` }}>
              <SectionTitle>
              ...
              <ModernTextField
                label="Owner Office"
                {...register("ownerOffice")}
                fullWidth
                error={!!errors.ownerOffice}
                helperText={errors.ownerOffice?.message}
                InputProps={{
                  startAdornment: (
                    <InputAdornment position="start">
          ...
          <DialogActions sx={{ p: 3, gap: 2 }}>
            ...
            <ActionButton 
              ...
              variant="contained"
              sx={{ animation: `${slideInLeft} 0.6s ease-out 0.4s both` }}
            >
              Add Application
            </ActionButton>
          </DialogActions>
