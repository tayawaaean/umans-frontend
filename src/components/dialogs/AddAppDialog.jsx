...
import { registerAppSchema } from "../../utils/validationSchema";
  ...
  return (
    <Dialog open={open} onClose={handleClose} fullWidth>
        ...
        <DialogContent>
            ...
            <TextField label="URL" {...register("url")} fullWidth margin="dense" error={!!errors.url} helperText={errors.url?.message} />
