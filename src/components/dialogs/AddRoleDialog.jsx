...
import { Autorenew as GenerateIcon, Visibility, VisibilityOff, Security, Apps, Person, Business } from "@mui/icons-material";
      ...
      <Fade in={open} timeout={300}>
        <Box>
          ...
          <DialogContentStyled>
            ...
            <FormSection sx={{ animation: `${fadeInUp} 0.6s ease-out 0.3s both` }}>
              <SectionTitle>
          ...
          <DialogActions sx={{ p: 3, gap: 2 }}>
            ...
            <ActionButton 
              ...
              variant="contained"
              sx={{ animation: `${slideInLeft} 0.6s ease-out 0.5s both` }}
            >
              Add Role Assignment
            </ActionButton>
          </DialogActions>
